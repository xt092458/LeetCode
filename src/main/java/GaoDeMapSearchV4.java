...
public class GaoDeMapSearchV4 {
    ...
    public static void main(String[] args) {
        // 指定要搜索的地点名称
        //String locationName = "河北省桥西区友谊南大街与新石中路交叉口北国超市(尚峰汇生活广场店)";
        //String locationName = "河北省石家庄市桥西区汇丰路8号北国超市(西美花街店)";
        ...
        //String locationName = "河北省石家庄市桥西区中山西路845号北国超市(西兴店)";
        //String locationName = "河北省石家庄市桥西区裕华西路北国超市(益友购物中心店)";
        //String locationName = "河北省石家庄市新华区联盟路368号北国超市(益元店)";
        //String locationName = "河北省石家庄市长安区胜利北街289号北国超市(益庄店)";
        //String locationName = "河北省石家庄市裕华区长江大道北国超市(长江店)";
        String locationName = "河北省石家庄市新华区中华北大街238号北国超市(中环店)";
        ...
        // 指定搜索范围（单位：米）
        //int radius = 3000;List<String> keywords = Arrays.asList("商场");
        // 指定搜索关键词
        int radius = 1000;List<String> keywords = Arrays.asList("小区","学校","超市");
        // 生成Excel表格
    ...
    private static List<String[]> searchNearby(String location, int radius, String keyword) {
        ...
        int page = 0;
        int offset = 25; // 最大每页200条

        while (true) {
            List<String[]> results = searchNearbyWithPagination(location, radius, keyword, page, offset);

            // 如果返回结果少于limit，说明已经获取完所有结果
     ...
     * @return 搜索结果
     */
    private static List<String[]> searchNearbyWithPagination(String location, int radius, String keyword, int page, int offset) {
        List<String[]> results = new ArrayList<>();

        try {
            // 构建周边搜索API请求URL
            String url = PLACE_AROUND_URL + "?key=" + API_KEY + "&location=" + location +
                    "&radius=" + radius + "&keywords=" + keyword +
                    "&page=" + page + "&offset=" + offset + "&extensions=all";
